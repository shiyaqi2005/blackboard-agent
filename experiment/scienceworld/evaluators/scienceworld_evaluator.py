...
from experiment.scienceworld.evaluators.base_evaluator import BaseEvaluator


class ScienceWorldEvaluator(BaseEvaluator):
    """Run ScienceWorld episodes and persist results via a shared writer."""
    ...
    def run_episode(
        ...
        **kwargs,
        ...
        """Run one ScienceWorld episode and optionally write it out immediately."""
        if not episode_id:
